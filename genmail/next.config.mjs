          ...
          },
          {
            ...
            value:
              process.env.NODE_ENV === "development"
                ? "default-src 'self'; worker-src 'self' blob:; script-src 'self' 'unsafe-inline' 'unsafe-eval' http://localhost:* https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app https://va.vercel-scripts.com https://vercel.live; style-src 'self' 'unsafe-inline' https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app; img-src 'self' data: https://*.supabase.co https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app; connect-src 'self' http://localhost:* https://*.supabase.co https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app wss://*.clerk.dev https://*.clerk.accounts.dev https://clerk-telemetry.com https://vercel.live; frame-src 'self' http://localhost:* https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app https://challenges.cloudflare.com https://vercel.live; frame-ancestors 'self';"
                : "default-src 'self'; worker-src 'self' blob:; script-src 'self' 'unsafe-inline' https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app https://va.vercel-scripts.com https://vercel.live; style-src 'self' 'unsafe-inline' https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app; img-src 'self' data: https://*.supabase.co https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app; connect-src 'self' https://*.supabase.co https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app wss://*.clerk.dev https://*.clerk.accounts.dev https://clerk-telemetry.com https://vercel.live; frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev https://clerk.genmail.app https://challenges.cloudflare.com https://vercel.live; frame-ancestors 'self';",
          },
        ],
      },
    ];
