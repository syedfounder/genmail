...
import PrivacyShieldIcon from "./PrivacyShieldIcon";
    ...
    <section className="py-20 px-6 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          {/* Main Feature */}
          <div className="relative md:col-span-2 bg-background border border-border rounded-2xl p-8 h-full overflow-hidden min-h-[400px] md:min-h-0">
